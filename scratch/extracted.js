...
`;
            ...
            const dynamicMessage = `${studentName} is a ${traitListText.toLowerCase()} individual with hobbies like ${student.hobbies || 'learning'} and interests in ${student.interests || 'technology'}. Based on their RIASEC profile, they are highly aligned with careers like ${topCareers.slice(0, 3).map(c => c.name).join(', ')}.`;
...
${careersText}
` +
                `Explore your path at skillsense.in!
                    ...
                    <div style="display: flex; gap: 28px; flex-wrap: wrap; align-items: flex-start;">
                        ...
                        <div style="flex: 1; min-width: 320px; display: flex; flex-direction: column; align-items: center;">
                            ...
                            <div id="shareableCardElement" style="
                                ...
                                padding: 24px;
                                border-radius: 16px;
                                background: radial-gradient(135deg, #120e36 0%, #070913 100%);
                            ...
                            ">
                                <!-- Glowing backgrounds -->
                                <div style="position: absolute; top: -10%; left: -10%; width: 180px; height: 180px; background: radial-gradient(circle, rgba(109, 74, 255, 0.2) 0%, transparent 70%); pointer-events: none;"></div>
                                <div style="position: absolute; bottom: -10%; right: -10%; width: 180px; height: 180px; background: radial-gradient(circle, rgba(0, 212, 255, 0.12) 0%, transparent 70%); pointer-events: none;"></div>
                                ...
                                <div style="margin-bottom: 20px; position: relative; z-index: 2;">
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                                        ${topCareers.slice(0, 6).map((c, idx) => '<div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.04); padding: 8px 10px; border-radius: 8px; display: flex; align-items: center; justify-content: flex-start; gap: 4px;"><span style="font-size: 0.78rem; font-weight: 600; color: rgba(255,255,255,0.85); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 150px;">' + (idx + 1) + '. ' + c.name + '</span></div>').join('')}
                                    </div>
                                </div>

                                <!-- Footer branding -->
                                <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 12px; position: relative; z-index: 2;">
                                    <div style="font-size: 0.68rem; color: rgba(255,255,255,0.35); font-weight: 500;">
                                        Explore at <b>skillsense.in</b>
                                    </div>
